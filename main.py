...
# Load in the UI_MainWindow and QMainWindow classes created in Qt Creator,
#  so that the Main class can inherit from their layouts, props, names, etc.
...
class Main(QMainWindow, UI_MainWindow):
    ...
    def __init__(self, tableData, headers, colors,
        ...
        # Do some necessaryily Qt tricks
        ...
        # Keep the voltage spacing, mean voltage, and mean current up to date
        #  with the values that are in the table
        self.aggregateTableForPlot()

        # Set up the QWidget with an MplCanvas and NavigationToolbar instance
        self.rectangles = []
        self.rects = []
